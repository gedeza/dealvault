...
export const DEAL_STATUS_COLORS: Record<DealStatus, string> = {
  ...
  verified: "bg-emerald-100 text-emerald-800 dark:bg-emerald-900/30 dark:text-emerald-400 border border-emerald-200 dark:border-emerald-800",
...
export const COMMODITIES = ["gold", "diamonds", "platinum", "tanzanite"] as const;
